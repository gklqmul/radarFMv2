...
#         """
#         Input:  z_flat [B*T, 64, 256]
#         Output: z_refined_flat [B*T, 64, 256]
#         """
...
#     """
#     radar -> encoder -> temporal_adapter -> coarse_head
#     """
...
#         z = self.encoder(radar_flat)        # [B*T, 64, 256]
#         # z = self.temporal_adapter(z, B, T)  # 时序增强
        
#         z_global = z.mean(dim=1)            # 聚合为全局特征 [B*T, 256]
...
def stage1_loss(pred, gt):
    ...
    valid_mask: [B, T] bool
    """
    valid_mask = (gt.abs().sum(dim=(2, 3)) > 1e-6)  # [B,T] bool
    # [B,T,J]
...
def main():
    ...
    save_dir = "/code/radarFMv2/checkpoints_baseline2"
    ...
    ckpt_path = "/code/radarFMv2/checkpoints_baseline2/best_model.pt"
