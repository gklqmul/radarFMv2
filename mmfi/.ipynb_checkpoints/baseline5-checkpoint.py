...
class RadarPoseRefiner(nn.Module):
    ...
    def get_coarse_prior(self, radar_input):
        ...
        x0 = torch.zeros(B*T, 17, 3, device=radar_input.device)# [BT,256]
    ...
    def load_pretrained_stage1(self, ckpt_path, freeze=True):
        ...
        print("Missing examples:", msg.missing_keys[:30])
        print("Unexpected examples:", msg.unexpected_keys[:30])
...
def main():
    ...
    # 设置保存路径
    save_path = "/data/mmfi/checkpoints_baseline5"
   ...
   # --- 2. 数据准备 ---
    ...
    ckpt_path = "/data/mmfi/checkpoints_baseline5/best_refiner.pt"
