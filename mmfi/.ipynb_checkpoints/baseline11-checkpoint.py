...
def main():
    ...
    save_path = "/data/mmfi/checkpoints_baseline11"
    ...
    # ckpt_stage1 = "/data/mmfi/checkpoints_baseline10/best_model.pt"
    # model.load_pretrained_stage1(ckpt_stage1, freeze=True)

    ckpt_path = "/data/mmfi/checkpoints_baseline11/best_refiner.pt"
