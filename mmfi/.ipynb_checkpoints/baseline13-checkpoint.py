...
class RadarPoseRefiner(nn.Module):
    ...
    def forward(self, radar_input):
        ...
        x_coarse = torch.zeros(B*T, 17, 3, device=radar_input.device)# [BT,256]
...
def main():
    ...
    # 设置保存路径
    save_path = "/data/mmfi/checkpoints_baseline13"
    ...
    # ckpt_stage1 = "/data/mmfi/checkpoints_baseline2/best_model.pt"
    # model.load_pretrained_stage1(ckpt_stage1, freeze=True)

    ckpt_path = "/data/mmfi/checkpoints_baseline13/best_refiner.pt"
