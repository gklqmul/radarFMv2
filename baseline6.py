...
class RadarPoseRefiner(nn.Module):
    def __init__(self, in_channels=6, radar_embed_dim=256, num_joints=27, parent_list=None):
        ...
        # --- Stage 2: Pure Regression (替换 FM) ---
        # self.refiner = RegressionRefiner(
        #     num_joints=num_joints, 
        #     embed_dim=512, 
        #     radar_feat_dim=radar_embed_dim
        # )
    ...
    def forward(self, radar_input):
        ...
        x_coarse, _, _ = self.coarse_head(z_global) # [BT, 27, 3]
...
def main():
    ...
    # 设置保存路径
    save_path = "/code/radarFMv2/checkpoints_baseline6"
    ...
    ckpt_path = "/code/radarFMv2/checkpoints_baseline6new/best_refiner.pt"
