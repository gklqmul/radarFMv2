...
class RadarPoseRefiner(nn.Module):
    ...
    @torch.no_grad()
    def inference(self, radar_input, steps=5, method="heun"):
        """
        多步 ODE 推理：
...
def main():
    ...
    # 设置保存路径
    save_path = '/code/radarFMv2/checkpoints_basemodelFM'
    ...
    ckpt_path = "/code/radarFMv2/checkpoints_basemodelFM/best_refiner.pt"
