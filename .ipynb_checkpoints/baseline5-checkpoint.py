...
class RadarPoseRefiner(nn.Module):
    ...
    def get_coarse_prior(self, radar_input):
        ...
        x0 = torch.zeros(B*T, 27, 3, device=radar_input.device)# [BT,256]
...
def main():
    ...
    # 设置保存路径
    save_path = "/code/radarFMv2/checkpoints_baseline5"
    ...
    ckpt_path = "/code/radarFMv2/checkpoints_baseline5/best_refiner.pt"
