...
def evaluate_sequence(
    ...
    for batch_idx, (radar_seq, skeleton_seq) in enumerate(pbar):
        ...
        pred_n = pred_mm[valid_mask]
        gt_n = gt_mm[valid_mask]
        M = v_gt.shape[0]
        if M == 0:
            continue
...
def main():
    ...
    # 设置保存路径
    save_path = "/code/radarFMv2/checkpoints_baseline12newdata"
    ...
    ckpt_path = "/code/radarFMv2/checkpoints_baseline12newdata/best_refiner.pt"
